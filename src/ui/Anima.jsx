...
// const anime = require('#/system/anime.min');

const animaStyles = require('./css/Anima.css');
...
class Anima extends React.Component {
    ...
    render () {
        return (
            <div className={animaStyles["animation-wrapper"]}>
                <div className={"sphere-animation" + ` ${animaStyles["svg-sphere-animation"]}`}>
                    <svg className={"sphere" + ` ${animaStyles["svg-sphere"]}`} viewBox="0 0 440 440" stroke="rgba(80,80,80,.35)">
                        <defs>
